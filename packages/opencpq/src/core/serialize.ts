        ...
        switch (typeof o) {
            ...
            case 'object': {
                ...
                if (ctor === String) {
                    out.push(
                        'S:',
                        serializeString((o as { valueOf(): string }).valueOf())
                    );
                    return;
                }
                if (ctor === Date) {
            ...
            default:
                throw new Error(
                    `serialization not supported for type '${typeof o}'`
                );
        }
    }
    ...
    function parse(label?: string): unknown {
        ...
        switch (token) {
            ...
            case 'N:':
                return register(
                    new Number(
                        parseFloat(expectNextToken('number', isNumberToken))
                    )
                );
            case 'S:':
                return register(
